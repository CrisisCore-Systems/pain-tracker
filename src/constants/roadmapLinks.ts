...
export const roadmapLinks = {
  holisticMilestones: {
    ...
    summary: 'Milestone timelines will showcase celebrations and breakthrough moments gathered from your progress entries.',
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+holistic+milestones',
  ...
  copingCoach: {
    ...
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+coping+strategy',
    issueLabel: 'explore open tasks'
  },
  comparisonAnalytics: {
    href: matrixAnchor('comparison-analytics-20'),
    label: 'Comparison Analytics 2.0',
    summary: 'We are expanding comparison analytics to contrast treatments, time ranges, and custom cohorts.',
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+comparison+analytics',
    issueLabel: 'track roadmap work'
  },
  visualComparison: {
    href: matrixAnchor('visual-comparison-charts'),
    label: 'Visual Comparison Charts',
    summary: 'Interactive charts will let you visualize how outcomes shift across time periods and treatments.',
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+visual+comparison',
  ...
  empathyIntelligence: {
    ...
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+empathy+intelligence',
  ...
  neuralPatterns: {
    ...
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+neural+empathy',
    issueLabel: 'inspect neural pattern tasks'
  },
  wisdomJourney: {
    href: matrixAnchor('empathy-intelligence-deep-dives'),
    label: 'Empathy Intelligence Deep Dives',
    summary: 'Wisdom journey timelines will chart insights, learning arcs, and reflection milestones.',
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+wisdom+journey',
    issueLabel: 'follow wisdom tracker work'
  },
  temporalAnalysis: {
    href: matrixAnchor('empathy-intelligence-deep-dives'),
    label: 'Empathy Intelligence Deep Dives',
    summary: 'Temporal empathy analysis will highlight daily, weekly, and seasonal empathy rhythms.',
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+temporal+empathy',
  ...
  predictiveInsights: {
    ...
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+predictive+empathy',
  ...
  culturalEmpathy: {
    ...
    issueUrl: 'https://github.com/CrisisCore-Systems/pain-tracker/issues?q=is%3Aopen+cultural+empathy',
