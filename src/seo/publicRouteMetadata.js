...
export const publicRouteMetadata = [
  ...
  },
  {
    ...
    description: 'A composite case study showing how a local-first PainTracker workflow can reduce documentation burden while keeping health records under user control.',
  ...
  },
  {
    ...
    description: 'Inspect release evidence, threat model documents, and defensibility materials behind CrisisCore trust claims.',
