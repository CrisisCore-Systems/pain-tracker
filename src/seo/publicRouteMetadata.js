...
export const publicRouteMetadata = [
  ...
  },
  {
    ...
    description: 'Use PainTracker free in your browser, install it for offline use, or self host it. Keep pain records private and available when you need them.',
  ...
  },
  {
    ...
    title: 'Pain Tracker App That Works Offline and Protects Privacy | Pain Tracker',
    description: 'Pain Tracker is a private offline-first pain tracker app for daily symptom logging, trigger tracking, flare patterns, and clinician-friendly exports when you choose.',
    canonicalUrl: `${SITE_URL}/pain-tracker-app`,
    ogImage: DEFAULT_OG_IMAGE,
  },
  {
    path: '/pain-tracking-app',
    title: 'Pain Tracking App That Works Offline and Keeps Records Private | Pain Tracker',
    description: 'Looking for a pain tracking app? Pain Tracker lets you track pain privately, works offline, requires no account, and helps you bring better records to appointments.',
  ...
  resource('pain-diary-template-pdf', 'Pain Diary Template PDF — Free Clinician-Designed Printable | Pain Tracker', 'Download a free, clinician-designed pain diary template PDF. Tracks pain intensity, location, medications, triggers, sleep, and mood - ready for doctor appointments, WorkSafeBC claims, and disability documentation.'),
  resource('daily-pain-tracker-printable', 'Daily Pain Tracker Printable PDF Free | PainTracker', 'Download a free daily pain tracker printable PDF to record pain levels, medications, flare ups, triggers, daily limits, mood, and notes for doctor visits.'),
  resource('weekly-pain-log-pdf', 'Weekly Pain Log PDF — Free 7-Day Pain Tracker Template | Pain Tracker', 'Download a free weekly pain log PDF. 8-section 7-day spread tracks daily pain, sleep, medications, activity, mood, triggers, and weekly patterns - ideal for appointments and disability claims.'),
  resource('monthly-pain-tracker-printable', 'Monthly Pain Tracker Printable — Free 30-Day Template | Pain Tracker', 'Download a free monthly pain tracker printable. 8-section 30-day template tracks daily pain calendar, sleep, medications, functional impact, triggers, mood, and monthly summary - ideal for treatment reviews and disability claims.'),
  resource('pain-scale-chart-printable', 'Pain Scale Chart Printable — Free 0-10 NRS Visual Reference | Pain Tracker', 'Download a free printable pain scale chart. Visual 0-10 Numeric Rating Scale with descriptors, faces, colors, and functional impact - the clinical standard for consistent pain reporting.'),
  resource('symptom-tracker-printable', 'Symptom Tracker Printable — Free Comprehensive Daily Symptom Log | Pain Tracker', 'Download a free symptom tracker printable. Track fatigue, sleep quality, mood, brain fog, energy, and more alongside pain - the complete picture your doctor needs for chronic illness management.'),
  resource('migraine-pain-diary-printable', 'Migraine Pain Diary Printable - Free Headache Tracker Template (2026) | Pain Tracker', 'Download our free 6-page migraine diary PDF. Track all 4 migraine phases, auras, 30+ common triggers, medications, and monthly patterns. Recommended by the American Headache Society tracking framework.'),
  resource('printable-pain-log-sheet', 'Printable Pain Log Sheet — Free Simple Daily Pain Tracker You Can Print Right Now | Pain Tracker', 'Download a free printable pain log sheet with daily pain ratings, symptom tracking, medication log, and notes section. Print and start tracking in under a minute.'),
  resource('chronic-pain-diary-template', 'Chronic Pain Diary Template — Free Long-Term Pain Tracker for Flares, Baseline & Trends | Pain Tracker', 'Download a free 6-page chronic pain diary template with baseline/flare tracking, trigger identification, treatment logs, and monthly trend reviews for long-term pain management.'),
  resource('7-day-pain-diary-template', '7-Day Pain Diary Template — Free One-Week Pain Tracker for Doctor Appointments | Pain Tracker', 'Download a free 7-day pain diary template. One-week format with morning, midday, and evening tracking, medication logs, and a doctor-ready weekly summary.'),
  resource('how-to-track-pain-for-doctors', 'How to Track Pain for Doctors — What Your Doctor Actually Needs | Pain Tracker', 'Learn exactly what to track and how to present pain data to your doctor in 15-minute appointments. 7 key data points, appointment prep checklist, and free tracking templates.'),
  resource('what-to-include-in-pain-journal', 'Pain Journal Checklist for Doctor Visits | PainTracker', 'Learn what to include in a pain journal so your notes are useful at doctor visits. Track pain levels, medications, triggers, sleep, and daily function with a simple checklist.'),
  resource('how-doctors-use-pain-diaries', 'How Doctors Use Pain Diaries — The Clinical Perspective | Pain Tracker', 'Understand how doctors actually use pain diary data to make treatment decisions. 6 clinical uses, decision timeline, and how to make your tracking clinically useful.'),
  resource('pain-diary-for-specialist-appointment', 'Pain Diary for Specialist Appointment — What to Track & Bring | Pain Tracker', 'Prepare for your specialist appointment with the right pain diary data. What pain specialists, rheumatologists, neurologists, and surgeons need. Free one-page summary template.'),
  resource('symptom-tracking-before-diagnosis', 'Symptom Tracking Before Diagnosis — What to Track When You Don\'t Know What\'s Wrong | Pain Tracker', 'Learn what to track when your pain has not been diagnosed yet. Pattern recognition guide, pre-diagnosis tracking categories, and doctor-ready summary template.'),
  resource('documenting-pain-for-disability-claim', 'Documenting Pain for Disability Claim — Complete Evidence Guide | Pain Tracker', 'Learn exactly how to document chronic pain for disability claims. What adjusters look for, 6 mistakes that get claims denied, evidence pyramid, and free templates to build your case.'),
  resource('worksafebc-pain-journal-template', 'WorkSafeBC Pain Journal Template - Free BC Workers Comp Pain Diary (2026) | Pain Tracker', 'Download our free 6-page WorkSafeBC pain journal PDF. Designed for BC workplace injury claims - tracks work-related pain, functional capacity, treatment compliance, and return-to-work readiness in the format case managers need.'),
  resource('pain-journal-for-disability-benefits', 'Pain Journal for Disability Benefits — Free Benefits-Ready Template | Pain Tracker', 'Download a free pain journal template designed specifically for disability benefits applications. Covers SSDI, LTD, WorkSafeBC. Includes functional limitation tracking and evidence-ready formatting.'),
  resource('daily-functioning-log-for-disability', 'Daily Functioning Log for Disability — Free Functional Capacity Tracker | Pain Tracker', 'Download a free daily functioning log designed for disability claims. Track self-care, household, work, social, and physical activities with capacity ratings evaluators use.'),
  resource('fibromyalgia-pain-diary', 'Fibromyalgia Pain Diary — Free 6-Page Fibro Symptom Tracker | Pain Tracker', 'Download a free fibromyalgia pain diary that tracks all 6 symptom domains: widespread pain, fatigue, fibro fog, sleep, sensitivity, and mood. Designed for ACR criteria and rheumatology appointments.'),
  resource('chronic-back-pain-diary', 'Chronic Back Pain Diary — Free 6-Page Back Pain Tracker | Pain Tracker', 'Download a free chronic back pain diary designed for spine-specific tracking. Document pain location, radiation patterns, activity triggers, posture, and PT exercises for better treatment outcomes.'),
  resource('arthritis-pain-tracker', 'Arthritis Pain Tracker — Free 6-Page Joint Pain Diary | Pain Tracker', 'Download a free arthritis pain tracker for RA, OA, PsA, and gout. Track morning stiffness, joint-by-joint pain, swelling, functional impact, and treatment response.'),
  resource('nerve-pain-symptom-log', 'Nerve Pain Symptom Log — Free 6-Page Neuropathy Tracker | Pain Tracker', 'Download a free nerve pain symptom log for neuropathy, sciatica, and neurological pain. Track burning, tingling, numbness, shooting pain, progression, and treatment response.'),
  resource('endometriosis-pain-log', 'Endometriosis Pain Log — Free 6-Page Endo Symptom Tracker | Pain Tracker', 'Download a free endometriosis pain log that tracks pelvic pain, cycle phases, GI symptoms, fatigue, and treatment response. Designed to shorten the 7-year diagnostic wait.'),
  resource('crps-pain-diary-template', 'CRPS Pain Diary Template — Free Complex Regional Pain Syndrome Tracker | Pain Tracker', 'Download a free CRPS pain diary tracking burning pain, allodynia, color and temperature changes, swelling, motor symptoms, and limb comparison. Aligned with Budapest diagnostic criteria.'),
  resource('neuropathy-symptom-tracker', 'Neuropathy Symptom Tracker — Free Peripheral Neuropathy Tracker PDF | Pain Tracker', 'Download a free neuropathy symptom tracker covering sensory, motor, autonomic, and balance symptoms. Track progression, falls, and treatment response for neurologist visits.'),
