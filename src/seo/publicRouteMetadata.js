...
const RESOURCES_STARTER_PACK = [
  {
    name: 'Daily Pain Tracker Template',
    url: '/resources/daily-pain-tracker-printable',
    description:
      'Daily symptom, trigger, medication, and note capture when you need the simplest starting point.',
  },
  {
    name: 'Weekly Pain Journal Template',
    url: '/resources/weekly-pain-tracker-printable',
    description: 'A short pattern view for treatment changes, flares, and appointment prep.',
  },
  {
    name: 'Monthly Pain Tracker Printable',
    url: '/resources/monthly-pain-tracker-printable',
    description: 'A 30-day view for patterns, flares, sleep disruption, and treatment response.',
  },
  {
    name: 'Doctor Visit Pain Notes Sheet',
    url: '/resources/doctor-visit-pain-summary-template',
    description:
      'A concise appointment-ready summary built for short visits and clearer conversation.',
  },
  {
    name: 'Medication Response Tracker',
    url: '/resources/medication-and-pain-log',
    description:
      'Track what you took, when you took it, what relief you got, and what side effects followed.',
  },
  {
    name: 'Functional Impact Log',
    url: '/resources/functional-capacity-log',
    description:
...
<main id="initial-loader" aria-label="PainTracker resources" style="padding: 2rem 1.5rem 4rem; max-width: 68rem; margin: 0 auto; color: #f1f5f9;">
  ...
  <h1 class="initial-route-heading" style="max-width: 18ch; margin-bottom: 1.25rem;">Free Pain Tracking Resources</h1>
  <p style="max-width: 56rem; line-height: 1.7; color: #cbd5e1;">PainTracker provides free, privacy first tools for recording pain, symptoms, flares, medication patterns, daily function, and long term health notes without forcing users into cloud accounts or unnecessary data collection.</p>
  ...
  <section style="margin-top: 2rem; border: 1px solid rgba(100, 116, 139, 0.45); border-radius: 1rem; padding: 1.5rem; background: rgba(15, 23, 42, 0.7);">
    <h2 style="font-size: 1.65rem; margin-bottom: 0.75rem;">Free pain tracking resources by task</h2>
    <p style="line-height: 1.7; color: #cbd5e1;">Pick the format that protects your energy today: print a simple tracker, use a chronic pain diary for longer patterns, check the pain scale chart before scoring, or move into private offline tracking when paper becomes hard to review.</p>
    <div style="display: grid; gap: 1rem; margin-top: 1rem;">
      ...
      <section>
        <h3 style="font-size: 1.1rem; color: #f8fafc;">Long term tracking</h3>
        <ul style="margin: 0.5rem 0 0; padding-left: 1.25rem; color: #e2e8f0; line-height: 1.8;">
          <li><a href="/resources/chronic-pain-diary-template" style="color: #7dd3fc;">Chronic pain diary template</a></li>
          <li><a href="/resources/what-to-include-in-pain-journal" style="color: #7dd3fc;">What to include in a pain journal</a></li>
        </ul>
      </section>
      <section>
        <h3 style="font-size: 1.1rem; color: #f8fafc;">Private digital tracking</h3>
        <ul style="margin: 0.5rem 0 0; padding-left: 1.25rem; color: #e2e8f0; line-height: 1.8;">
          <li><a href="/" style="color: #7dd3fc;">Free private offline pain tracker app</a></li>
          <li><a href="/download" style="color: #7dd3fc;">Download PainTracker</a></li>
          <li><a href="/tracking-data-policy" style="color: #7dd3fc;">Tracking data policy</a></li>
        </ul>
      </section>
      <section>
        <h3 style="font-size: 1.1rem; color: #f8fafc;">For appointments, claims, and reports</h3>
        <ul style="margin: 0.5rem 0 0; padding-left: 1.25rem; color: #e2e8f0; line-height: 1.8;">
          <li><a href="/download" style="color: #7dd3fc;">Download PainTracker</a></li>
          <li><a href="/resources/worksafebc-pain-journal-template" style="color: #7dd3fc;">WorkSafeBC pain journal template</a></li>
          <li><a href="/resources/daily-pain-tracker-printable" style="color: #7dd3fc;">Daily pain tracker printable</a></li>
          <li><a href="/resources/chronic-pain-diary-template" style="color: #7dd3fc;">Chronic pain diary template</a></li>
        </ul>
      </section>
...
function stripSiteSuffix(title) {
  return title.replace(/\s+\|\s+Pain Tracker$/u, '').replace(/\s+\|\s+PainTracker\.ca$/u, '');
}
...
function makeOrganizationSchema() {
  return {
    ...
    sameAs: ['https://github.com/CrisisCore-Systems/pain-tracker', 'https://blog.paintracker.ca/'],
    contactPoint: {
      '@type': 'ContactPoint',
    ...
    if (route.path === '/resources') {
      structuredData.push(
        makeCollectionPageSchema({
          name: 'Free Pain Tracking Resources',
          description:
...
export const publicRouteMetadata = [
  ...
  },
  {
    ...
    description:
      'Compare Free, Basic, Pro, and Enterprise plans for private, offline-capable pain tracking, worker-controlled reports, and structured documentation workflows.',
  ...
  },
  {
    ...
    canonicalUrl: `${SITE_URL}/case-study`,
    ogImage: DEFAULT_OG_IMAGE,
    breadcrumbName: 'Case Study',
    prerenderHeading: 'Structured Documentation Without a Cloud Health Database',
  },
  {
    path: '/proof',
    ...
    canonicalUrl: `${SITE_URL}/proof`,
    ogImage: DEFAULT_OG_IMAGE,
    breadcrumbName: 'Proof Materials',
    prerenderHeading: 'Proof Materials and Release Evidence',
  },
  {
    path: '/privacy',
    title: 'Privacy Policy | Pain Tracker — Local-First, Zero-Cloud Architecture',
    description:
      'Read how Pain Tracker keeps health data local by default, avoids cloud storage of pain records, and gives you control over exports and sharing.',
  ...
  },
  {
    ...
    description:
      'PainTracker.ca is a private offline pain journal for daily symptom logging, trigger tracking, flare patterns, and worker-controlled exports when you choose.',
  ...
  },
  {
    ...
    description:
      'Learn how Pain Tracker approaches local-first use, privacy, offline pain tracking, and trauma-informed design for daily symptom logging and worker-controlled records.',
  ...
  },
  {
    ...
    description:
      'See what Pain Tracker stores locally, what it does not collect by default, and how optional analytics and exports are handled.',
  ...
  },
  {
    ...
    description:
      'Download the Pain Tracker whitepaper covering local-first architecture, privacy boundaries, and the product threat model.',
  ...
  },
  {
    ...
    description:
      'Read the Overton Framework canon page, including the Protective Computing discipline overview, DOI, and canonical citation.',
  ...
  },
  {
    ...
    description:
      'Official, stable reference page for the current CNET download location for Pain Tracker.',
  ...
  },
  {
    ...
    description:
      'Browse Pain Tracker demonstration views and screenshot-ready previews of the export workflow, body map, and subscription screens.',
  ...
  },
  {
    ...
    description:
      'Submit a testimonial or story about using Pain Tracker, with optional anonymization and explicit publication consent.',
  ...
  resource(
    'medication-and-pain-log',
    'Medication and Pain Log: Free Printable for Dose, Timing, and Relief Tracking',
  ...
  resource(
    'doctor-visit-pain-summary-template',
    'Doctor Visit Pain Summary Template: Free One-Page Appointment Sheet',
  ...
  resource(
    'body-pain-chart-template',
    'Body Pain Chart Template: Free Printable Body Location Tracker',
  ...
  resource(
    ...
    'Chronic Pain Journal Template: Free Daily Tracking Worksheet',
  ...
  resource(
    ...
    'How to Start a Pain Journal: Simple Daily Method That Sticks',
  ...
  resource(
    ...
    'How to Describe Pain Clearly for Doctors: Words, Scale, Location, and Pattern',
    'Learn how to describe pain clearly using location, quality words, severity scale, timing, triggers, and functional impact.'
  ),
  resource(
    'how-to-track-pain-triggers',
    'How to Track Pain Triggers: Practical Method for Sleep, Stress, Weather, and Activity',
  ...
  resource(
    ...
    'Pain Tracking for Fibromyalgia: What to Record and Why It Helps',
  ...
  resource(
    ...
    'How to Use a Pain Scale Correctly: NRS, VAS, and Functional Impact',
  ...
  resource(
    ...
    'Pain Diary for Insurance Claims: What to Document and Why It Matters',
  ...
  resource(
    ...
    'Printable Symptom Checklist: Free 40+ Symptom Log for Doctor Visits',
  ...
  resource(
    'pain-relief-log',
    'Pain Relief Log: Free Printable for Tracking What Actually Helps',
  ...
  resource(
    ...
    'Pain Tracking Before Surgery: What to Document and How It Helps',
  ...
  resource(
    ...
    'Chronic Fatigue Symptom Log: Free ME/CFS and Fatigue Tracking Template',
  ...
  resource(
    ...
    'Functional Capacity Log: Free Printable for Daily Limitations and Activities',
  ...
  resource(
    ...
    'Pain Diary for Disability Application: What to Track, How to Format, and Why It Matters',
  ...
  resource(
    ...
    'Sleep and Pain Tracker: Free Template for Tracking How Sleep Affects Pain',
  ...
  resource(
    ...
    'Pain Tracking for Arthritis: What to Record for RA, OA, and PsA',
  ...
  resource(
    ...
    'Pain Tracking for Migraines: How to Log Attacks, Triggers, and Treatment Response',
  ...
  resource(
    ...
    'Weather and Pain Tracker: Track How Weather Affects Your Chronic Pain',
  ...
  resource(
    ...
    'Exercise and Pain Log: Track Activity and Pain Together to Find What Helps',
  ...
  resource(
    ...
    'Best Pain Tracking App for Chronic Pain: What to Look For in 2026',
    'What makes the best pain tracking app for chronic pain? Key features to look for — offline access, data ownership, user-controlled exports, and privacy — and how PainTracker.ca compares.'
  ),
  resource(
    'pain-tracker-for-iphone',
    'Pain Tracker for iPhone: Free App That Works Offline Without an Account',
  ...
  resource(
    'pain-journal-for-kids-and-teens',
    'Pain Journal for Kids and Teens: Free Simple Tracking for Young People',
  ...
  resource(
    ...
    'Pain Diary Template Free Download: Daily, Weekly, and Monthly Formats',
  ...
  resource(
    ...
    'Chronic Pain Self-Care Log: Track Rest, Pacing, and Recovery Strategies',
  ...
  resource(
    ...
    'Pain Tracking for Back Pain: What to Record for Lower and Upper Back Pain',
  ...
  resource(
    ...
    'Pain Tracking for Nerve Pain: How to Log Neuropathic Symptoms and Triggers',
  ...
  resource(
    ...
    'Pain Tracker for Android: Free App That Works Offline Without an Account',
  ...
  resource(
    ...
    "Pain Diary for Workers' Compensation: Worker-Controlled Work Injury Notes",
  ...
  resource(
    ...
    'Pain Diary for Rheumatologist: What to Track Before Your Appointment',
  ...
  resource(
    ...
    'Pain Log for Physical Therapy: Track Progress and Response During Rehab',
  ...
  resource(
    ...
    'Chronic Pain Medication Log: Track Medications, Doses, and Effectiveness',
  ...
  resource(
    ...
    'Daily Symptom Tracker: Free Template for Chronic Illness and Pain Management',
  ...
  resource(
    ...
    'Pain Tracking App for Seniors: Simple, Free, and Offline-Capable',
  ...
  resource(
    ...
    'Pain Diary for Personal Injury Claim: How to Document Pain and Function for Legal Proceedings',
  ...
  resource(
    ...
    'Pain Tracking for Lupus: How to Log SLE Pain, Flares, and Organ Symptoms',
  ...
  resource(
    ...
    'Pain Tracking for Endometriosis: How to Log Pelvic Pain, Cycle Correlation, and Functional Impact',
  ...
  resource(
    ...
    'Pain Tracker for iPad: Free Offline App — No Download Required',
  ...
  resource(
    ...
    'Pain Diary for Social Security Disability: How to Document Pain for SSDI and SSI Claims',
  ...
  resource(
    ...
    'Pain Diary for Long-Term Disability Insurance: How to Document Chronic Pain for LTD Claims',
  ...
  resource(
    ...
    'Pain Tracking for Cancer Pain: How to Log Oncology Pain and Treatment Response',
  ...
  resource(
    ...
    'Pain Tracking for Ehlers-Danlos Syndrome: How to Log Hypermobility, Subluxations, and Chronic Pain',
  ...
  resource(
    ...
    'Pain Diary for Physiotherapist: What to Track Between PT Sessions',
  ...
  resource(
    ...
    'Pain Management Journal: How to Keep a Daily Log That Improves Your Treatment',
  ...
  resource(
    ...
    'Pain Tracking for Multiple Sclerosis: How to Log MS Pain, Spasticity, and Neuropathic Symptoms',
  ...
  resource(
    ...
    'Pain Tracking for CRPS: How to Log Complex Regional Pain Syndrome Symptoms',
  ...
  resource(
    ...
    'Pain Tracking for Sciatica: What to Log for Nerve Pain Down the Leg',
  ...
  resource(
    ...
    'Pain Tracking After Surgery: How to Log Post-Surgical Pain and Recovery Progress',
  ...
  resource(
    ...
    'Pain Diary for GP Appointment: What to Track and Bring to Your Family Doctor',
  ...
  resource(
    ...
    'Pain Tracking for Headaches: How to Log Tension, Cluster, and Chronic Daily Headaches',
  ...
  resource(
    ...
    'Pain Tracking for Hip Pain: What to Log for Hip OA, Bursitis, and Labral Tears',
  ...
  resource(
    ...
    'Pain Tracking for Shoulder Pain: What to Log for Rotator Cuff, Impingement, and Frozen Shoulder',
  ...
  resource(
    ...
    'Chronic Pain Flare Tracker: How to Log Flares, Triggers, and Recovery Time',
  ...
  resource(
    ...
    'Pain Diary Template for Insurance Claims: How to Document Chronic Pain for Insurers',
  ...
  resource(
    ...
    'Download a free 7-day pain diary template. One-week format with morning, midday, and evening tracking, medication logs, and a doctor-ready weekly summary.'
  ),
  resource(
    'how-to-track-pain-for-doctors',
    'How to Track Pain for Doctors — What Your Doctor Actually Needs | PainTracker.ca',
    'Learn exactly what to track and how to present pain data to your doctor in 15-minute appointments. 7 key data points, appointment prep checklist, and free tracking templates.'
  ),
  resource(
  ...
  resource(
    ...
    'How Doctors Use Pain Diaries — The Clinical Perspective | PainTracker.ca',
    'Understand how doctors actually use pain diary data to make treatment decisions. 6 clinical uses, decision timeline, and how to make your tracking clinically useful.'
  ),
  resource(
    'pain-diary-for-specialist-appointment',
    'Pain Diary for Specialist Appointment — What to Track & Bring | PainTracker.ca',
    'Prepare for your specialist appointment with the right pain diary data. What pain specialists, rheumatologists, neurologists, and surgeons need. Free one-page summary template.'
  ),
  resource(
    'symptom-tracking-before-diagnosis',
    "Symptom Tracking Before Diagnosis — What to Track When You Don't Know What's Wrong | PainTracker.ca",
    'Learn what to track when your pain has not been diagnosed yet. Pattern recognition guide, pre-diagnosis tracking categories, and doctor-ready summary template.'
  ),
  resource(
    'documenting-pain-for-disability-claim',
    'Documenting Pain for Disability Claim — Complete Evidence Guide | PainTracker.ca',
    'Learn exactly how to document chronic pain for disability claims. What adjusters look for, 6 mistakes that get claims denied, evidence pyramid, and free templates to build your case.'
  ),
  resource(
    'worksafebc-pain-journal-template',
    'WorkSafeBC Pain Journal Template for Workplace Injury Notes',
    'For workplace injury documentation: keep structured notes about pain, functional limits, medication changes, triggers, and recovery patterns for appointment and claim-related review.'
  ),
  resource(
  ...
  resource(
    ...
    'Download a free fibromyalgia pain diary that tracks all 6 symptom domains: widespread pain, fatigue, fibro fog, sleep, sensitivity, and mood. Designed for ACR criteria and rheumatology appointments.'
  ),
  resource(
    'chronic-back-pain-diary',
    'Chronic Back Pain Diary — Free 6-Page Back Pain Tracker | PainTracker.ca',
    'Download a free chronic back pain diary designed for spine-specific tracking. Document pain location, radiation patterns, activity triggers, posture, and PT exercises for better treatment outcomes.'
  ),
  resource(
    'arthritis-pain-tracker',
    'Arthritis Pain Tracker — Free 6-Page Joint Pain Diary | PainTracker.ca',
    'Download a free arthritis pain tracker for RA, OA, PsA, and gout. Track morning stiffness, joint-by-joint pain, swelling, functional impact, and treatment response.'
  ),
  resource(
  ...
  resource(
    ...
    'Download a free CRPS pain diary tracking burning pain, allodynia, color and temperature changes, swelling, motor symptoms, and limb comparison. Aligned with Budapest diagnostic criteria.'
  ),
  resource(
    'neuropathy-symptom-tracker',
    'Neuropathy Symptom Tracker — Free Peripheral Neuropathy Tracker PDF | PainTracker.ca',
    'Download a free neuropathy symptom tracker covering sensory, motor, autonomic, and balance symptoms. Track progression, falls, and treatment response for neurologist visits.'
  ),
  resource(
    'pain-diary-for-doctor-visits',
    'Pain Diary Template for Doctor Visits: What to Track, How to Summarize, and What to Bring',
    'A printable pain diary template built for doctor appointments. Track what matters in the two weeks before your visit, then condense it into a one-page summary your GP or specialist can actually use.'
  ),
  resource(
    'symptom-journal-template',
    'Symptom Journal Template: Track 40+ Symptoms, Triggers, Meds, and Functional Impact (Free Download)',
    'Free printable symptom journal template covering physical symptoms, cognitive changes, sleep, medications, functional impact, and triggers. 3-minute daily entries, 6 categories, pattern-ready format.'
  ),
  resource(
    'chronic-pain-log-printable',
    'Chronic Pain Log Printable: Free Daily, Flare, and Monthly Tracking Sheets',
    'Download a free printable chronic pain log with four formats: daily entry sheet, flare episode record, weekly summary, and monthly trend log. Works for all chronic pain conditions.'
  ),
  resource(
    'pain-journal-examples',
    'Pain Journal Examples: Real Entries for Worst Days, Standard Days, Flares, and Good Days',
    'See real pain journal entry examples for every kind of day - 1-minute minimal entries for bad days, 3-minute standard entries, detailed flare documentation, and good-day records. Copy the format directly.'
  ),
...
export const privateRouteMetadata = [
  ...
  },
  {
    ...
    description:
      'Unlock or set up your local Pain Tracker vault to access your private records on this device.',
  ...
  },
  {
    ...
    description:
      'Open the protected Pain Tracker application for your private records and exports.',
