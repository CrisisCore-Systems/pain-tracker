...
export const borders = {
  ...
  // Gradient borders
  gradient: 'border border-transparent [background:linear-gradient(white,white)_padding-box,linear-gradient(135deg,#667eea_0%,#764ba2_100%)_border-box]',
  gradientPrimary: 'border-2 border-transparent [background:linear-gradient(var(--background),var(--background))_padding-box,linear-gradient(135deg,rgb(59,130,246),rgb(147,51,234))_border-box]',
