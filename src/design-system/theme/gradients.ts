...
export const gradients = {
  ...
  radialPrimary:
    'bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-600 via-indigo-600 to-transparent',
  radialAccent:
    'bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-purple-600 via-pink-600 to-transparent',
...
export const borderGradients = {
  primary:
    'border-transparent bg-clip-padding [border-image:linear-gradient(to_right,#3b82f6,#8b5cf6,#a855f7)_1]',
