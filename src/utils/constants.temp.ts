...
export const ACTIVITIES: Activities = {
  ...
  HOUSEHOLD: ['Cooking', 'Cleaning', 'Laundry', 'Shopping', 'Yard work', 'Home maintenance'],
  WORK_RELATED: ['Desk work', 'Lifting', 'Bending', 'Reaching', 'Computer use', 'Driving'],
  SOCIAL: ['Family activities', 'Social events', 'Hobbies', 'Community participation'],
  MOBILITY_AIDS: [
    'Cane',
    'Walker',
    'Wheelchair',
...
export const MEDICATIONS: Medications = {
  ...
  FREQUENCY: ['As needed', 'Once daily', 'Twice daily', 'Three times daily', 'Four times daily'],
  EFFECTIVENESS: ['Very effective', 'Moderately effective', 'Slightly effective', 'Not effective'],
};
...
export const INTERVENTIONS: Interventions = {
  ...
  STATUS: ['Currently receiving', 'Completed', 'Planned', 'On waitlist'],
};
