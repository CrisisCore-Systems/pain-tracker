...
const SEO = {
  ...
  metaTitle: 'Weekly Pain Log PDF (2026) | Free 7-Day Template, No Email',
  metaDescription:
...
const TEMPLATE_SECTIONS = [
  {
    ...
    description:
      '7-day spread with AM, midday, PM, evening, and worst pain plus primary location for each day',
    color: 'text-red-400',
    bg: 'bg-red-500/10',
  },
  {
    ...
    title: 'Sleep & Energy',
    description:
      'Bedtime, wake time, hours, sleep quality (1-5), morning energy (0-10), and disturbances',
  ...
  },
  {
    ...
    description:
      '7-day log for every intervention — meds, physio, TENS, heat/ice — with relief ratings and side effects',
  ...
  },
  {
    ...
    description:
      'Self-care, housework, walking, work, social, and exercise rated 0-5 for each day of the week',
    color: 'text-cyan-400',
    bg: 'bg-cyan-500/10',
  },
  {
    ...
    description:
      'Track weather, stress, poor sleep, activity, posture, food — check off each day to reveal patterns',
  ...
  },
  {
    ...
    description:
      'Color-coded mood scale with daily mood, anxiety, stress ratings, and emotional observations',
    color: 'text-pink-400',
    bg: 'bg-pink-500/10',
  },
  {
    ...
    description:
      'Two-column summary: pain highs/lows, flare count, most effective treatment, common triggers, and goals',
    color: 'text-sky-400',
    bg: 'bg-sky-500/10',
  },
  {
    ...
    description:
      'Dedicated space for patterns noticed, questions, concerns, and medication requests for your appointment',
...
const WEEK_FLOW = [
  {
    ...
    bg: 'bg-indigo-500/15',
    description:
      "Spend 2-3 minutes recording that day's pain, sleep, meds, and function. Quick entries build the most reliable data.",
  },
  {
    time: 'End of Week',
    icon: TrendingUp,
    ...
    bg: 'bg-sky-500/15',
    description:
      'Complete the weekly pattern analysis: best/worst days, triggers, treatment effectiveness, and goals for next week.',
  },
  {
    time: 'Compare Weeks',
    icon: Repeat,
    ...
    description:
      'After 3-4 weeks, lay your logs side by side. Repeating patterns — which day is always worst, which triggers recur — become obvious.',
  },
];
    ...
    <div className="min-h-screen bg-background landing-always-dark">
      ...
      <main id="main-content" role="main">
        ...
        <section className="hero-section-dramatic py-20 sm:py-28" aria-labelledby="hero-heading">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="landing-subhead text-lg sm:text-xl max-w-2xl mx-auto mb-4">
              Daily pain, sleep, medications, activity impact, triggers, mood, and a weekly pattern
              analysis — 8 structured sections on one printable spread.
            </p>
            <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto mb-4">
              Use the printable if you need a paper-first weekly view. Switch to the app when you
              want trends, exports, and less manual review work before appointments.
            </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm flex items-center gap-3 flex-wrap">
                    ...
                    <span className="flex items-center gap-1">
                      <Calendar className="w-3.5 h-3.5" /> 1 sheet per week
                    </span>
                    <span className="flex items-center gap-1">
        ...
        <section
          ...
          aria-labelledby="week-flow-heading"
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-slate-400 text-center mt-2 mb-10 max-w-xl mx-auto">
              A few minutes each evening, a quick summary each week, and side-by-side comparison
              over time.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid sm:grid-cols-3 gap-6">
              {[
                {
                  value: '72%',
                  label: 'of pain patterns are day-of-week linked',
                  source: 'Chronic Pain Research, 2022 — occupational-activity correlations',
                },
                {
                  value: '4 wks',
                  label: 'to identify consistent weekly cycles',
                  source: 'Pain Management, 2020 — minimum tracking duration study',
                },
                {
                  value: '2 min',
                  label: 'per evening entry with structured columns',
                  source: 'User feedback — median time for daily row completion',
                },
              ].map(stat => (
                <div
                  key={stat.label}
            ...
            <div className="mt-10 bg-slate-800/50 rounded-2xl p-6 sm:p-8 border border-slate-700/50">
              <p className="text-slate-300 leading-relaxed text-base sm:text-lg">
                Research consistently shows that patients underestimate their good days and
                overestimate their bad days when recalling from memory — a phenomenon called
                &quot;peak-pain bias.&quot;{' '}
                <strong className="text-white">
                  A weekly spread format counters this by giving you 7 days of objective data side
                  by side.
                </strong>{' '}
              ...
              <div className="flex items-start gap-4 p-5 bg-slate-800/60 rounded-xl border border-slate-700/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Standard 0-10 NRS pain scale, functional impact ratings, and clinical sleep/mood
                    metrics providers immediately understand.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-5 bg-slate-800/60 rounded-xl border border-slate-700/40">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-gradient-to-b from-slate-800 to-slate-800/60 rounded-2xl p-8 sm:p-10 border border-slate-700/50 shadow-xl">
              ...
              <p className="text-slate-400 mb-6 max-w-lg mx-auto">
                Print 4 copies — one month of weekly tracking is the minimum threshold where
                patterns become consistent and the data becomes actionable for your provider.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  href="/assets/weekly-pain-log.pdf"
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
              Weekly tracking turns &quot;it was a bad month&quot; into specific, actionable
              patterns your provider can use. Start this week — even partial entries matter.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="/assets/weekly-pain-log.pdf"
