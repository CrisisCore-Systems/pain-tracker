  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Login Card */}
        <div 
          className="rounded-2xl p-8 border border-border bg-card relative overflow-hidden"
          style={{
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-muted border border-border text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50 transition-all"
                  disabled={isLoading}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder=""
                  className="w-full pl-12 pr-16 py-3.5 rounded-xl bg-muted border border-border text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50 transition-all"
                  disabled={isLoading}
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl text-foreground font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-0.5 shadow-lg shadow-sky-500/25 hover:shadow-sky-500/40"
              style={{
