  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl bg-background text-foreground min-h-screen">
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-muted border border-border text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50 transition-all"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-muted-foreground mb-2">
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl bg-muted border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50 transition-all"
            >
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl bg-muted border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-rose-500/50 focus:border-rose-500/50 transition-all"
            >
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            >
              <div className="w-full h-16 bg-muted rounded-lg mb-3"></div>
              <p className="text-sm font-medium text-foreground flex items-center justify-center gap-2">
      ...
      <div className="relative flex justify-end">
        <button
          onClick={handleSave}
          className="flex items-center gap-2 px-8 py-3.5 rounded-xl text-foreground font-medium transition-all hover:-translate-y-0.5 shadow-lg shadow-sky-500/25 hover:shadow-sky-500/40"
          style={{
