...
export type UnwrapKeyJSON = WrappedKeyPayload | KeyBundleWrappedPayload | KeyBundleRawPayload | OpaqueKeyPayload;
...
export function isKeyBundleWrapped(v: unknown): v is KeyBundleWrappedPayload {
  return !!v && typeof v === 'object' && ('encWrapped' in (v as any) || 'hmacWrapped' in (v as any));
}
