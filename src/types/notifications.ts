...
export const DEFAULT_NOTIFICATION_TEMPLATES: NotificationTemplate[] = [
  {
    ...
    message: 'How are you feeling right now? Taking a moment to track your pain can help you understand your patterns.',
  ...
  },
  {
    ...
    message: 'It\'s time to take your {{medication_name}}. Remember to track how it\'s working for you.',
  ...
  },
  {
    ...
    message: 'You have an appointment with {{provider_name}} in {{hours_until}} hours. Don\'t forget to prepare any questions.',
  ...
  },
  {
    ...
    message: 'Congratulations! You\'ve reached your goal of {{goal_description}}. You\'re doing amazing work.',
  ...
  },
  {
    ...
    message: 'It\'s been a week since your last check-in. How have you been feeling? Your consistency matters.',
  ...
  },
  {
    ...
    message: 'It\'s been {{days_since_backup}} days since your last data backup. Keep your health data safe.',
