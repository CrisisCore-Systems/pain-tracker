...
export const LandingFooter: React.FC = () => {
  ...
  const footerNavLinkClass =
    'group flex h-auto min-h-0 items-center gap-2 border-0 bg-transparent p-0 text-left text-slate-300 transition-all duration-200 hover:text-sky-400';
  const footerExternalLinkClass =
    'group flex h-auto min-h-0 items-center gap-2 border-0 bg-transparent p-0 text-left text-slate-300 transition-all duration-200 hover:text-sky-400';
  const footerBlogLinkClass =
    'group flex h-auto min-h-0 items-center border-0 bg-transparent p-0 text-left text-slate-400 transition-all duration-200 hover:text-purple-400';
  ...
  const proofNetworkLinks: ResourceLink[] = [
    ...
    {
      label: 'Protective Computing Library',
      href: 'https://protective-computing.github.io',
      icon: Shield,
    },
    ...
    <footer className="relative">
      ...
      <div className="relative overflow-hidden py-20 sm:py-24">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          />
          <div
            className="absolute top-1/2 right-1/3 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-medium bg-slate-800/80 border border-white/10 backdrop-blur-sm">
              ...
              <span className="text-slate-200">Choose a tracking path</span>
            </div>

            {/* Headline */}
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.1] tracking-tight">
              Need a Pain Record That{' '}
              <span className="relative inline-block">
                <span className="bg-gradient-to-r from-sky-400 via-cyan-400 to-emerald-400 bg-clip-text text-transparent">
                  Stays Useful?
                </span>
                <svg
                  className="absolute -bottom-2 left-0 w-full h-3 text-sky-500/30"
                  viewBox="0 0 200 8"
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
              Private local tracking and worker-controlled exports for appointments, claim-related
              discussions, and personal records.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button
                ...
                style={{
                  ...
                  boxShadow:
                    '0 10px 40px rgba(14, 165, 233, 0.3), 0 0 60px rgba(14, 165, 233, 0.1)',
                }}
              >
                <span className="relative z-10 flex items-center gap-2">
                  <Zap className="h-5 w-5" />
                  Download PainTracker
            ...
            <p className="text-slate-500 text-sm flex items-center justify-center gap-4 flex-wrap">
              <span className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" /> No account required
              </span>
              <span className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" /> Printable fallback
                available
              </span>
              <Link
                to="/tracking-data-policy"
                className="flex items-center gap-1.5 text-slate-400 transition-colors hover:text-sky-300"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" /> Tracking data policy
              </Link>
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-14 sm:py-16">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5 lg:gap-12">
            ...
            <div className="col-span-1 space-y-6 sm:col-span-2 lg:col-span-2">
              ...
              <p className="text-slate-300 max-w-md leading-relaxed">
                Privacy-first pain tracking with local insights, reporting tools, and
                trauma-informed design for people who need useful records under real-world
                constraints.
              </p>
            ...
            <div className="space-y-5">
              ...
              <ul className="space-y-4 text-sm">
                {(
                  [
                    { label: 'Pain Tracking Resources', to: '/resources' },
                    {
                    ...
                    {
                      label: 'Pain Diary Starter Pack',
                      href: '/assets/free-pain-tracking-starter-pack.zip',
                    },
                    { label: 'Whitepaper (PDF)', to: '/whitepaper' },
                    {
                      label: 'Overton Framework (Canon)',
                      to: '/overton-framework',
                      icon: BookOpen,
                    },
                    { label: 'Download PainTracker', to: '/download' },
          ...
          <div className="mt-10 pt-6 border-t border-white/5 flex flex-col items-center gap-3 text-sm text-center md:flex-row md:justify-between md:text-left">
            ...
            <p className="flex flex-wrap items-center justify-center gap-2 text-slate-400 md:justify-end">
              Made with{' '}
              <Heart
                className="h-4 w-4 fill-current text-rose-500 animate-pulse"
                style={{ animationDuration: '2s' }}
              />{' '}
              for chronic pain survivors
            </p>
          </div>
          ...
          >
            <p className="text-sm leading-relaxed text-slate-400">
              <strong className="text-white">Privacy-first by default:</strong> Core tracking data
              is stored on your device. Exports and optional backup/sync are user-initiated.{' '}
              Optional analytics can be enabled explicitly and is disabled by default. Built in
              accordance with{' '}
              <a
