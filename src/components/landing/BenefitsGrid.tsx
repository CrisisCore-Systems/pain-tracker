...
const benefits = [
  ...
  },
  {
    ...
    description: 'Advanced heuristic analysis with 8 algorithms detects medication efficacy, triggers, correlations, and trends.',
    stat: '8 algorithms',
    iconClass: 'icon-sky',
