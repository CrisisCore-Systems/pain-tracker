      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3 className="text-lg font-semibold mb-2">
            {tierIcons[requiredTier]} {requiredTier.charAt(0).toUpperCase() + requiredTier.slice(1)} Feature
          </h3>
...
export const UsageWarning: React.FC<UsageWarningProps> = ({
  ...
  return (
    <div className={`rounded-lg p-4 mb-4 ${
      isAtLimit ? 'bg-red-50 border-2 border-red-300 text-red-700' :
      isNearLimit ? 'bg-orange-50 border-2 border-orange-300 text-orange-700' :
...
export const TierBadge: React.FC<TierBadgeProps> = ({
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 rounded-full border-2 font-semibold ${config.classes} ${sizeClasses[size]}`}>
