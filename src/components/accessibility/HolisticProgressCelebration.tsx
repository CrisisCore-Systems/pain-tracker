  ...
  consistency: [
    {
      ...
      personalMessage:
        "Consistency is a form of self-love. You're learning about yourself and that takes courage.",
      celebrationLevel: 'warm' as const,
      icon: Calendar,
      suggestedReward:
        'Treat yourself to something comforting - a warm tea, favorite song, or cozy blanket time',
    },
    {
      threshold: 7,
      ...
      personalMessage:
        "Each day you track is a day you choose to understand yourself better. That's profound self-advocacy.",
    ...
    },
    {
      ...
      personalMessage:
        'A month of choosing yourself, every single day. Your dedication to understanding your pain is inspiring.',
      celebrationLevel: 'profound' as const,
      icon: Mountain,
      suggestedReward:
        'This deserves a special celebration - something that honors your commitment to yourself',
    },
  ],
  selfCare: [
    {
      ...
      personalMessage:
        "Being kind to yourself when you're hurting isn't selfish - it's necessary. You're learning to be your own best friend.",
      celebrationLevel: 'warm' as const,
      icon: Heart,
    ...
    },
    {
      ...
      personalMessage:
        'Listening to your body and choosing rest is an act of wisdom and courage. Productivity culture has nothing on your self-awareness.',
      celebrationLevel: 'warm' as const,
      icon: Feather,
    ...
    },
    {
      ...
      personalMessage:
        "You remembered that you have tools, and you used them. That's growth and self-compassion in action.",
      celebrationLevel: 'enthusiastic' as const,
      icon: Shield,
  ...
  courage: [
    {
      ...
      personalMessage:
        "Sharing your experience takes tremendous courage. You're breaking the isolation that pain tries to create.",
      celebrationLevel: 'profound' as const,
      icon: Flame,
    ...
    },
    {
      ...
      personalMessage:
        "Asking for help isn't weakness - it's strength and self-awareness. You're building your support network.",
      celebrationLevel: 'warm' as const,
      icon: Compass,
    ...
    },
    {
      ...
      personalMessage:
        'Protecting your energy and honoring your limits is an act of self-respect. Your boundaries matter.',
      celebrationLevel: 'enthusiastic' as const,
      icon: Shield,
      suggestedReward:
        'Reflect on how setting this boundary felt - your future self will thank you',
    },
  ],
  growth: [
    {
      ...
      personalMessage:
        'Self-awareness is a superpower. Each pattern you notice gives you more control over your experience.',
      celebrationLevel: 'warm' as const,
      icon: Target,
    ...
    },
    {
      ...
      personalMessage:
        "Innovation in your own care shows incredible resilience. Whether it worked or not, you're expanding your toolkit.",
      celebrationLevel: 'enthusiastic' as const,
      icon: Sparkles,
  ...
  connection: [
    {
      ...
      personalMessage:
        "Finding your people and building community is healing for everyone involved. You're not walking this path alone.",
      celebrationLevel: 'profound' as const,
      icon: Rainbow,
    ...
    },
    {
      ...
      personalMessage:
        "Even while managing your own challenges, you showed up for someone else. That's the heart of community.",
      celebrationLevel: 'warm' as const,
      icon: Heart,
  ...
  resilience: [
    {
      ...
      personalMessage:
        "You made it through. That's not small - that's everything. Your resilience is remarkable.",
      celebrationLevel: 'profound' as const,
      icon: Mountain,
    ...
    },
    {
      ...
      personalMessage:
        "Pain doesn't have to steal all your joy. This moment proves that you can hold both - difficulty and delight.",
      celebrationLevel: 'enthusiastic' as const,
      icon: Flower,
...
export function HolisticProgressCelebration({
  ...
  useEffect(() => {
    ...
    if (selfCareActivities.length > 0) {
      const achievement: Achievement = {
        ...
        shareableText:
          "I practiced self-care today. Taking care of myself isn't selfish - it's necessary. 🌸",
        timestamp: new Date(),
      };
      newAchievements.push(achievement);
    }
    ...
    if (courageousMoments.length > 0) {
      const achievement: Achievement = {
        ...
        shareableText:
          'I found the courage to speak about my experience today. My voice matters. 🔥',
        timestamp: new Date(),
      };
      newAchievements.push(achievement);
    }
  ...
  return (
    <div className="holistic-progress-celebration">
      ...
      {/* Progress Overview */}
      <ProgressOverview milestones={milestones} weeklyProgress={weeklyProgress} />

      {/* Recent Achievements */}
      {recentAchievements.length > 0 && <RecentAchievements achievements={recentAchievements} />}
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/70 rounded-lg p-4 mb-4">
        <p className="text-sm leading-relaxed italic">{achievement.personalMessage}</p>
      ...
      <div className="flex space-x-2">
        <TouchOptimizedButton variant="primary" onClick={onShare} className="flex-1">
          <Heart className="w-4 h-4 mr-2" />
          I'm proud of this
        </TouchOptimizedButton>

        <TouchOptimizedButton variant="secondary" onClick={onClose} className="px-4">
          ✕
        </TouchOptimizedButton>
      </div>
    </div>
...
function ProgressOverview({
  ...
  return (
    <div className="progress-overview bg-white border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-6">
                  ...
                  {isExpanded && (
                    <div className="mt-2 space-y-2 text-sm">
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        ...
                        {milestone.celebrationSuggestion}
                      </p>
                    </div>
                  )}
                </div>
...
function RecentAchievements({ achievements }: { achievements: Achievement[] }) {
  return (
    <div className="recent-achievements bg-white border border-gray-200 dark:border-gray-700 rounded-lg p-4">
      <h3 className="text-lg font-semibold mb-4 flex items-center">
      ...
      <div className="space-y-3">
        {achievements.slice(0, 5).map(achievement => {
          ...
          return (
            <div
              key={achievement.id}
              className="flex items-center space-x-3 p-2 bg-gray-50 dark:bg-gray-900 rounded-md"
            >
