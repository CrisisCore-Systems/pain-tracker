...
const agencyChoices: AgencyChoice[] = [
  {
    ...
    options: [
      ...
      {
        id: 'selective-sync',
        label: 'I choose what to export',
        description: 'Select specific data to include in exports or reports',
        empowermentMessage: 'You have granular control over your information',
        icon: Sliders,
      },
      {
        id: 'full-sync',
        label: 'Back up via export',
        description: 'Create password-protected exports you can store safely',
        empowermentMessage: 'You control where copies are stored',
        icon: RotateCcw,
      },
    ],
  },
