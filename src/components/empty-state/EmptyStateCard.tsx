        ...
        {showBenefits && (
          <div className="mt-12 pt-8 border-t border-border">
            <div className="text-center mb-8">
              <h4 className="text-lg font-semibold text-foreground mb-2">Why Track Your Pain?</h4>
              <p className="text-sm text-muted-foreground">
                Understanding your pain patterns can lead to better management and improved quality
                of life
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <div className="flex-shrink-0 p-2 bg-muted rounded-lg">{benefit.icon}</div>
                  <div>
