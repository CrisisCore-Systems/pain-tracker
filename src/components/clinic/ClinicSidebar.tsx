...
export function ClinicSidebar({ 
  ...
  return (
    <aside 
      className={`
        bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 transition-all duration-300 flex flex-col
    ...
    >
      ...
      {/* User Info */}
      {!collapsed && (
        <div className="p-3 sm:p-4 border-b border-slate-200 dark:border-slate-700 bg-slate-100/50 dark:bg-slate-800/50">
      ...
      <div className="p-3 sm:p-4 border-t border-slate-200 dark:border-slate-700">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 transition-colors text-slate-600 dark:text-slate-300"
