          ...
          {activeTab === 'preferences' && (
            <div className="space-y-6">
              <div className="flex items-center space-x-2 text-sm text-blue-700 bg-blue-100 p-3 rounded-lg">
                ...
                <span>
                  These settings are saved locally and never shared without your permission.
                </span>
              </div>
                  ...
                  <div className="mt-3">
                    {pref.type === 'boolean' && (
                      <label className="flex items-center space-x-3">
                        ...
                        />
                        <span className="text-sm">{pref.value ? 'Enabled' : 'Disabled'}</span>
                      </label>
                    )}
                  ...
                  <label className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded">
                    <div>
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">
                        Help improve pain management for others
                      </p>
                    </div>
...
export function EmpowermentMessageDisplay({
  context = 'general',
}: {
  context?: EmpowermentMessage['context'];
}) {
  const relevantMessages = empowermentMessages.filter(
    msg => msg.context === context || msg.context === 'general'
  );
