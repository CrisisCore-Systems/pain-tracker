...
export function ComparisonSection({
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Pain Worsening Since</label>
        <input
          type="date"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">New Limitations</label>
        <textarea
