...
export function WorkImpactSection({
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Days of Missed Work</label>
        <input
          type="number"
          min="0"
          value={missedWork}
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Modified Duties</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Work Limitations</label>
        <textarea
