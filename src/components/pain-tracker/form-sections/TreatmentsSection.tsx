  ...
  return (
    <div className="space-y-6" role="group" aria-labelledby="treatments-title">
      <div className="flex items-center space-x-3">
        <span className="text-2xl" role="img" aria-label="treatments">🏥</span>
            ...
            <CardContent className="p-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <label htmlFor={`treatment-date-${index}`} className="block text-sm font-medium text-foreground">
                    Date
                  </label>
                  <input
                ...
                <div className="space-y-1">
                  <label htmlFor={`treatment-effectiveness-${index}`} className="block text-sm font-medium text-foreground">
                    Effectiveness
                  </label>
                  <select
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="overall-treatment-effectiveness" className="block text-sm font-medium text-foreground mb-2">
          ...
          <p id="overall-treatment-effectiveness-hint" className="text-xs text-muted-foreground mt-1">
            How effective have your treatments been overall?
          </p>
        </div>

        <div>
          <label htmlFor="planned-treatments" className="block text-sm font-medium text-foreground mb-2">
            Planned Treatments
          </label>
          <textarea
