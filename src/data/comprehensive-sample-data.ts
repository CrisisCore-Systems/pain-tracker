/**
 * Comprehensive Sample Data - 60+ entries over 60 days
 * Demonstrates recovery journey with realistic progression
 */
...
export const comprehensiveSampleData: PainEntry[] = [
  // Week 9 (Days 60-54): Initial injury - Acute phase
  {
    id: 1,
    timestamp: daysAgo(60, 8),
    baselineData: {
      pain: 9,
      locations: ['Lower Back', 'Right Leg', 'Right Hip'],
      symptoms: ['Sharp pain', 'Severe stiffness', 'Numbness in leg', 'Muscle spasms'],
    },
    functionalImpact: {
      limitedActivities: ['Walking', 'Sitting', 'Standing', 'Bending', 'Lifting'],
      assistanceNeeded: ['Getting dressed', 'Getting out of bed', 'Bathing'],
      mobilityAids: ['Cane'],
    },
    medications: {
      current: [{
    ...
    qualityOfLife: {
      sleepQuality: 2,
      moodImpact: 2,
      socialImpact: ['Cancelled all activities'],
    },
    workImpact: {
      missedWork: 5,
      modifiedDuties: [],
      workLimitations: ['Unable to work'],
    },
    comparison: {
      worseningSince: 'Injury occurred while lifting heavy boxes at work',
      newLimitations: ['Cannot walk more than 5 minutes'],
    },
  ...
  
  {
    ...
    baselineData: {
      ...
      symptoms: ['Sharp pain', 'Stiffness', 'Numbness', 'Tingling'],
    },
    functionalImpact: {
    ...
    notes: 'Muscle relaxant helps sleep. Still severe pain. Waiting for MRI.',
  },

  {
    id: 3,
    timestamp: daysAgo(56, 9),
    baselineData: {
      pain: 8,
      locations: ['Lower Back', 'Right Leg'],
    ...
    functionalImpact: {
      limitedActivities: ['Walking', 'Sitting more than 15 min'],
      assistanceNeeded: ['Getting dressed'],
      mobilityAids: ['Cane'],
    },
    medications: {
    ...
    qualityOfLife: {
      sleepQuality: 5,
      moodImpact: 4,
      socialImpact: ['Missing family events'],
    },
    workImpact: {
      missedWork: 12,
      modifiedDuties: [],
    ...
    notes: 'MRI done. Slight improvement but still in significant pain.',
  },

  // Week 8 (Days 53-47): Starting treatment plan
  {
    id: 4,
    timestamp: daysAgo(53, 10),
    baselineData: {
      pain: 7,
      locations: ['Lower Back', 'Right Leg'],
      symptoms: ['Dull ache', 'Stiffness', 'Occasional sharp pain'],
    },
    functionalImpact: {
      limitedActivities: ['Walking', 'Prolonged sitting'],
      assistanceNeeded: [],
      mobilityAids: ['Cane'],
    },
    medications: {
    ...
    qualityOfLife: {
      sleepQuality: 6,
      moodImpact: 5,
      socialImpact: ['Limited social activities'],
    },
    workImpact: {
      missedWork: 15,
      modifiedDuties: [],
      workLimitations: ['Still unable to work'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
  ...
  {
    id: 5,
    timestamp: daysAgo(50, 11),
    baselineData: {
      pain: 7,
      locations: ['Lower Back'],
      symptoms: ['Dull ache', 'Morning stiffness', 'Occasional sharp pain with movement'],
    },
    functionalImpact: {
      limitedActivities: ['Walking more than 15 min', 'Sitting more than 20 min'],
      assistanceNeeded: [],
    ...
    qualityOfLife: {
      sleepQuality: 7,
      moodImpact: 6,
      socialImpact: ['Short visits with friends OK'],
    },
    workImpact: {
      missedWork: 17,
      modifiedDuties: [],
    ...
    notes: 'First physio session. Learning proper body mechanics. Gentle exercises assigned.',
  },

  {
    id: 6,
    timestamp: daysAgo(48, 15),
    baselineData: {
      pain: 6,
      locations: ['Lower Back'],
    ...
    functionalImpact: {
      limitedActivities: ['Prolonged walking', 'Prolonged sitting'],
      assistanceNeeded: [],
    ...
    notes: 'Doing daily exercises. Heat pack in morning helpful. Noticing gradual improvement.',
  },

  // Week 7 (Days 46-40): Continued improvement
  {
    id: 7,
    timestamp: daysAgo(46, 8),
    baselineData: {
      pain: 6,
      locations: ['Lower Back'],
    ...
    functionalImpact: {
      limitedActivities: ['Heavy lifting', 'Prolonged activities'],
      assistanceNeeded: [],
      mobilityAids: [],
    },
    medications: {
    ...
    workImpact: {
      missedWork: 21,
      modifiedDuties: [],
      workLimitations: ['Still off work but discussing return'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
...

  {
    ...
    baselineData: {
      pain: 5,
      locations: ['Lower Back'],
      symptoms: ['Mild stiffness', 'Occasional tightness'],
    },
    functionalImpact: {
      limitedActivities: ['Heavy lifting', 'Bending'],
      assistanceNeeded: [],
      mobilityAids: [],
    },
    medications: {
    ...
    workImpact: {
      missedWork: 24,
      modifiedDuties: [],
      workLimitations: ['Cleared for modified duties next week'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
    },
    notes: 'Great progress! Doctor cleared me for modified work duties. Feeling optimistic.',
  },

  {
    id: 9,
    timestamp: daysAgo(40, 9),
    baselineData: {
      pain: 5,
      locations: ['Lower Back'],
    ...
    functionalImpact: {
      limitedActivities: ['Heavy lifting'],
      assistanceNeeded: [],
      mobilityAids: [],
    },
    medications: {
    ...
    workImpact: {
      missedWork: 27,
      modifiedDuties: ['Light duty work'],
      workLimitations: ['No lifting over 10 lbs'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
  ...
  // Week 6 (Days 39-33): Return to work phase
  {
    ...
    functionalImpact: {
      limitedActivities: ['Heavy lifting', 'Prolonged bending'],
      assistanceNeeded: [],
      mobilityAids: [],
    },
    medications: {
    ...
    workImpact: {
      ...
      workLimitations: ['No lifting over 10 lbs', 'Frequent position changes'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
  ...
  {
    id: 11,
    timestamp: daysAgo(36, 15),
    baselineData: {
      pain: 4,
      locations: ['Lower Back'],
      symptoms: ['Occasional tightness'],
    },
    functionalImpact: {
      limitedActivities: ['Heavy lifting'],
      assistanceNeeded: [],
    ...
    workImpact: {
      missedWork: 31,
      modifiedDuties: ['Light duty'],
      workLimitations: ['No heavy lifting'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
    },
    notes: 'Comfortable at work. Doing well with exercises. Social life returning to normal.',
  },

  {
    id: 12,
    timestamp: daysAgo(33, 11),
    baselineData: {
      pain: 3,
      locations: ['Lower Back'],
      symptoms: ['Mild morning stiffness'],
    },
    functionalImpact: {
      limitedActivities: ['Heavy lifting'],
      assistanceNeeded: [],
    ...
    workImpact: {
      missedWork: 34,
      modifiedDuties: ['Gradual return to regular duties'],
      workLimitations: ['Cautious with heavy lifting'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
    },
    notes: 'Pain minimal. Mostly taking medication preventatively. Discussing full duty return.',
  },

  // Week 5 (Days 32-26): Near full recovery
  {
    id: 13,
    timestamp: daysAgo(30, 8),
    baselineData: {
      pain: 3,
      locations: ['Lower Back'],
    ...
    medications: {
      ...
      effectiveness: 'Pain manageable without medication most days',
    },
    treatments: {
      recent: [
        {
    ...
    workImpact: {
      missedWork: 37,
      modifiedDuties: [],
      workLimitations: ['Being cautious with technique'],
    },
    comparison: {
      worseningSince: '',
      newLimitations: [],
    },
    notes: 'Back to almost all normal activities! Maintaining exercise routine. Feeling great.',
  },

  {
    id: 14,
    timestamp: daysAgo(28, 14),
    baselineData: {
      pain: 2,
      locations: ['Lower Back'],
      symptoms: ['Occasional tightness after long days'],
    },
    functionalImpact: {
      limitedActivities: [],
      assistanceNeeded: [],
...

  {
    ...
    notes: 'Maintaining all gains. Exercise routine is part of daily life now. Feeling strong.',
  },

  // Weeks 4-2: Maintenance phase with occasional minor flare-ups
  {
    id: 16,
    timestamp: daysAgo(24, 16),
    baselineData: {
      pain: 3,
      locations: ['Lower Back'],
      symptoms: ['Mild ache after gardening'],
    },
    functionalImpact: {
      limitedActivities: [],
      assistanceNeeded: [],
    ...
    notes: 'Minor setback after overdoing yardwork. Learned to pace better. Resolved in 1 day.',
  },

  {
    ...
    notes: 'Check-in with physio went great. All metrics improved. Maintaining exercise routine.',
  },

  {
    id: 18,
    timestamp: daysAgo(18, 15),
    baselineData: {
      pain: 1,
      locations: ['Lower Back'],
      symptoms: ['Minimal, only after very long days'],
    },
    functionalImpact: {
      limitedActivities: [],
      assistanceNeeded: [],
    ...
    notes: 'Rarely think about my back anymore. Exercise is habit. Quality of life excellent.',
  },
  ...
  // Week 1-Current: Fully recovered
  {
    ...
    notes: 'Pain-free day! Completed a hike that would have been impossible 2 months ago.',
  },
