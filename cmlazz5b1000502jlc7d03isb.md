...
## Install PainTracker in under a minute
...
Visit paintracker.ca/app and use "Add to Home Screen" on mobile or the install icon on desktop.

**Step 2: Set your passphrase**

Choose a strong, memorable passphrase that encrypts all your health data locally.

**Step 3: Log your first entry**

Use the slider for intensity, tap the body map for location, and select pain quality descriptors.

**Step 4: Track daily for one week**

Log at least one entry per day at a consistent time to establish your tracking habit and baseline data.

**Step 5: Review analytics and export**

View your trends in the analytics dashboard, then export a PDF report for your next appointment.

## Frequently Asked Questions

### Do I need to create an account to use PainTracker?
...
### What devices does PainTracker work on?
...
### Can I use PainTracker without an internet connection?
