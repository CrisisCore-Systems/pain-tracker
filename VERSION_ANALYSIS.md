...
|----------|------------------|---------|
| `docs/ROADMAP.md` | `v0.1.0-beta` | Current version marker |
| `docs/MOBILE_OPTIMIZATION.md` | `2.0.0` | Feature version |
| `docs/PWA_BROWSER_TEST_PLAN.md` | `1.2 (Service Worker)` | Service worker version |
| `docs/ENCRYPTION_MIGRATION.md` | `2.0.0` | Ciphertext format version |
| `docs/UX_COMPETITIVE_ANALYSIS.md` | `1.0` | Analysis version |
...
- `docs/CLINIC_PORTAL_ENHANCEMENTS.md` - November 17, 2025
- Many others
