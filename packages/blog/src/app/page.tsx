  ...
  return (
    <div className="relative">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 gradient-bg-vibrant opacity-50" />
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse-soft" />
        <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-accent/10 rounded-full blur-3xl animate-pulse-soft" style={{ animationDelay: '1s' }} />
            ...
            <div className="flex flex-wrap items-center gap-8 text-sm" style={{ animationDelay: '600ms' }}>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">No tracking</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Featured Post */}
      {featuredPost && (
        <section className="container-blog-wide py-12 md:py-16">
      ...
      {/* Posts Grid */}
      {restPosts.length > 0 && (
        <section className="container-blog-wide py-12 md:py-20">
          {/* Section Header */}
      ...
      {/* Empty State */}
      {posts.length === 0 && (
        <section className="container-blog text-center py-24 md:py-32">
          <div className="relative inline-block mb-8">
            ...
            <div className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-primary/20 animate-bounce-in" style={{ animationDelay: '500ms' }} />
          </div>
