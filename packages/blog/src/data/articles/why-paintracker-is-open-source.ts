...
const article: ArticleData = {
  ...
  description:
    'Understand why PainTracker chose open source for a health application. Learn how code transparency provides verifiable privacy, community oversight, and long-term data safety.',
  ...
  sections: [
    {
      h2: 'Open source as a trust mechanism',
      paragraphs: [
