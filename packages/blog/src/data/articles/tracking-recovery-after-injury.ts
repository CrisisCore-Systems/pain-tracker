...
const article: ArticleData = {
  ...
  description:
    'Track your recovery after injury with structured symptom logging. Document progress for clinicians, insurers, and your own peace of mind.',
  ...
  sections: [
    ...
    {
      h2: 'Tracking non-linear progress',
      paragraphs: [
