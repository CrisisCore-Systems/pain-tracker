...
const article: ArticleData = {
  ...
  description:
    'A plain-language threat model for your health data. Who wants it, how they might get it, what PainTracker does about it, and where the limits are.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'PainTracker\'s security architecture is designed around a specific threat model. Being transparent about what it protects against, and what it does not, helps you make informed decisions about whether this approach matches your needs.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'PainTracker\'s defence: there is no server-side health data to breach. The server delivers static application code and has no database, no user data, and no API endpoints that receive health information. The attack surface for health data is zero at the server level.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'PainTracker\'s defence: there is no company database to subpoena. Your data exists only on your device, encrypted with your passphrase. No legal process can compel the developers to hand over data they do not possess. You control what is shared through selective exports.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'PainTracker\'s current defence is narrower than full deniability: panic mode allows quick dismissal of the current interface and replaces it with a low-stimulus overlay that reduces visible app state. The app runs as a Progressive Web App that can be named anything on the home screen. There are no push notifications that reveal pain tracking activity, no email receipts, and no calendar integrations that could expose health information through shared accounts.',
      ],
    },
    {
      h2: 'Threats we do not fully address',
      paragraphs: [
        'Honest security requires naming limitations. PainTracker cannot protect against a compromised operating system or malware with root access. These threats operate below the application layer and can intercept any data the browser processes. We cannot protect against physical coercion where someone forces you to reveal your passphrase. We cannot prevent a compromised browser from intercepting data before encryption.',
        'If you face these specific threats, additional measures beyond any single application are necessary: full-disk encryption, dedicated secure devices, and operational security practices. PainTracker provides strong protection within the browser application layer and is honest about threats that require system-level defences.',
      ],
    },
  ],
};
