...
const article: ArticleData = {
  ...
  description:
    'Use a structured migraine diary to track attack frequency, triggers, aura symptoms, and medication effectiveness. Export clinical reports for your neurologist.',
  ...
  sections: [
    {
      h2: 'Why migraine tracking is essential',
      paragraphs: [
    ...
    {
      h2: 'What to track for migraine management',
      paragraphs: [
    ...
    {
      h2: 'Monitoring medication effectiveness',
      paragraphs: [
    ...
    {
      h2: 'Recognising warning signs and patterns',
      paragraphs: [
