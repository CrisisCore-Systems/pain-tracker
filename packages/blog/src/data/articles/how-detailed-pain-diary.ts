...
const article: ArticleData = {
  ...
  description:
    'Too much detail creates burden and leads to abandonment. Too little lacks clinical value. Here is how to find the level that is sustainable and actually useful.',
  ...
  sections: [
    {
      h2: 'The two ways a pain diary fails',
      paragraphs: [
        'Pain diaries fail for two opposite reasons. Too little detail produces data that clinicians cannot use. Too much detail creates a tracking burden that leads to abandonment. The goal is not maximum detail. It is optimal detail: capturing the data points that are clinically meaningful while keeping the daily effort sustainable over months and years.',
        'Research on patient-reported outcome measures consistently shows that compliance drops sharply as tracking burden increases. A diary that takes three minutes per entry will be abandoned within weeks by most users. One that takes thirty seconds will be maintained indefinitely. The clinical value of consistent thirty-second entries far exceeds that of sporadic three-minute entries. This is not a minor trade-off. It is the fundamental design constraint.',
      ],
    },
    {
    ...
    {
      h2: 'Building your personal tracking protocol',
      paragraphs: [
        'Start with the essentials and track for two weeks. Review your data and ask: is there a pattern I cannot see because I am missing a specific data point? If yes, add that one field. After another two weeks, reassess. This iterative approach builds a personalised tracking protocol that captures what matters for your specific condition without unnecessary burden.',
