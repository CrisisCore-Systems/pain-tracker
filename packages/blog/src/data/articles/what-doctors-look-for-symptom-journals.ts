...
const article: ArticleData = {
  ...
  description:
    'Learn exactly what healthcare providers want to see in pain and symptom journals. Structure your tracking to maximise clinical value and improve appointment outcomes.',
  ...
  sections: [
    {
      h2: 'Why clinicians value symptom journals',
      paragraphs: [
    ...
    {
      h2: 'Presentation format and readability',
      paragraphs: [
    ...
    {
      h2: 'Common mistakes in symptom journals',
      paragraphs: [
    ...
    {
      h2: 'Preparing your journal for an appointment',
      paragraphs: [
