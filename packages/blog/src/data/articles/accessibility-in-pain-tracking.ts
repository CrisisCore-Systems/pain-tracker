...
const article: ArticleData = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'PainTracker targets Web Content Accessibility Guidelines 2.2 at the AA conformance level. In practical terms: all interactive elements are keyboard accessible, visual content meets minimum contrast ratios, touch targets are large enough for users with motor impairments, screen readers can navigate and interpret all content, and time-sensitive interactions provide sufficient time for all users.',
        'WCAG 2.2 introduced criteria particularly relevant to pain tracking: minimum target sizes for touch inputs, focus appearance requirements for keyboard navigation, and accessible authentication flows. PainTracker\'s passphrase entry and daily tracking interface are designed to meet these updated standards.',
      ],
    },
    {
      h2: 'Trauma-informed design in a health tool',
      paragraphs: [
        'Chronic pain is frequently associated with trauma, and pain tracking itself can be emotionally difficult. It asks you to engage with your own suffering on a daily basis. PainTracker\'s trauma-informed design philosophy addresses this through concrete practices: gentle, non-judgmental language throughout the interface, user control over the tracking experience, reduced cognitive load through structured inputs, and quick exit mechanisms.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'For PainTracker, accessibility and privacy are both expressions of the same core commitment: respect for the user. Respecting privacy means not taking data without consent. Respecting accessibility means not building tools people cannot use. Neither is optional. Neither is a later-stage feature.',
      ],
    },
  ],
};
