  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Location and quality matter. Where exactly, whether it radiates, how it feels, sharp, dull, burning, throbbing, aching, tingling. These details help clinicians narrow diagnoses and identify treatment targets. PainTracker provides a visual body map for location and structured quality descriptors so you are not scrambling for words during a flare.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'PainTracker is designed for entries under sixty seconds. Structured inputs, sliders, taps, toggles, replace typing wherever possible. The interface prioritizes the most clinically relevant data and makes everything else optional. A minimal entry every day is worth more than a detailed entry once a week.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'PainTracker supports tags, notes, and custom fields. Track sleep quality alongside morning pain to see if poor sleep predicts worse symptoms. Record energy levels during flares to document their full impact, not just the pain component. For fibromyalgia, where the diagnostic criteria explicitly include fatigue, sleep disturbance, and cognitive difficulties, multi-symptom tracking provides a clinical picture that intensity alone cannot.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'PainTracker stores all data locally, encrypted, exportable. No subscription that locks you out of historical data. No server that might shut down. No account that might be compromised. Your long-term symptom history is yours, accessible on your terms, for as long as you need it.',
      ],
    },
  ],
  faqs: [
    {
      ...
      answer:
        'Daily. Aim for at least one entry per day at a consistent time. PainTracker is designed for entries under sixty seconds, making daily tracking sustainable even during flares.',
    },
    {
      question: 'What is the best pain scale to use for tracking?',
      answer:
        'The 0–10 Numerical Rating Scale is the most widely used and clinically validated. PainTracker uses a visual slider, which is faster than selecting a number and produces consistent data across entries.',
    },
    {
