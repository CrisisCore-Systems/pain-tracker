...
const article: ArticleData = {
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Pain Tracker is a Progressive Web App that installs directly from your browser. No app store. No account. Visit www.paintracker.ca/start in Chrome, Safari, Edge, or Firefox on any device. On mobile, tap the browser\'s "Add to Home Screen" option. On desktop, click the install icon in the address bar. The app downloads to your device and works offline immediately.',
    ...
    },
    {
      ...
      paragraphs: [
        'Your passphrase encrypts all health data stored on your device. Choose something memorable but not easily guessable: at least four random words or twelve characters. This passphrase is never sent anywhere and cannot be recovered if you lose it. Write it down and store it somewhere safe if you are worried about forgetting it.',
        'The passphrase is your only key. Without it, your data is permanently inaccessible, by design. This zero-knowledge approach means no one can access your records without your explicit decision to share them.',
      ],
    },
    {
      h2: 'Log your first pain entry',
      paragraphs: [
        'The entry interface is built for speed. Slide to set your pain intensity on the 0 to 10 scale. Tap the body map to mark pain locations. Select quality descriptors that match your experience: aching, burning, stabbing, throbbing, others. Add optional notes if you want to capture context.',
        'Your first entry establishes your baseline. Do not overthink it. Record what you feel right now. Consistency matters more than precision. The structured inputs ensure every entry is comparable to every other entry, building a dataset that shows patterns over time.',
      ],
    },
    {
      h2: 'Build your first week of data',
      paragraphs: [
        'Commit to logging one entry per day for your first week. Anchor it to something you already do: after morning medication, before bed, at a consistent break time. The goal is to establish the habit before you need it urgently. After seven days, you will have enough data to see your first patterns in the analytics view.',
        'On high-pain days, the minimal entry path takes seconds. On better days, add medication details, functional impact notes, and tags. Both levels of detail are valuable. The key is that you logged something every day.',
      ],
    },
    {
      h2: 'Explore your analytics',
      paragraphs: [
        'After several entries, visit the analytics view to see your data. Trend charts show pain intensity over time. Time-of-day breakdowns reveal whether mornings or evenings are worse. Body map heatmaps show your most common pain locations. All analysis happens locally on your device. Nothing is sent to any server.',
        'These early analytics are the beginning. As your dataset grows over weeks and months, patterns become clearer: seasonal variations, medication correlations, trigger relationships, recovery trajectories.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Bring a printed report to your next medical appointment. Even a week of structured data gives your clinician more to work with than verbal recall. As your tracking history grows, your exports become increasingly valuable.',
      ],
    },
  ],
  howToSteps: [
    { name: 'Install the app', text: 'Visit www.paintracker.ca/start and use "Add to Home Screen" on mobile or the install icon on desktop.' },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Your passphrase cannot be recovered because it is never stored or transmitted. If you lose it, your encrypted data is permanently inaccessible. Write it down and store it somewhere safe.',
    },
  ],
};
