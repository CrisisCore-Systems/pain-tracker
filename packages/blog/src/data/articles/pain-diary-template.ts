...
const article: ArticleData = {
  ...
  sections: [
    ...
    {
      h2: 'What every pain diary entry actually needs',
      paragraphs: [
    ...
    {
      h2: 'Tracking medications and what you actually did about the pain',
      paragraphs: [
        'Medication logging transforms your pain diary from a record of symptoms into a treatment effectiveness monitor. Recording what you took, when you took it, and how your pain responded creates a dataset that helps both you and your prescriber optimise your regimen.',
        'Include over-the-counter medications, prescribed drugs, supplements, and non-pharmacological interventions like physiotherapy exercises, heat or cold application, and rest periods. This comprehensive tracking reveals which combinations of interventions actually help. That information is nearly impossible to obtain from memory alone.',
      ],
    },
    {
