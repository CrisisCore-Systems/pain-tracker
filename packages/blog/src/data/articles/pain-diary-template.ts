...
const article: ArticleData = {
  ...
  description:
    'Get a comprehensive pain diary template covering intensity, location, timing, medications, and functional impact. Designed for clinical usefulness and daily consistency.',
  ...
  sections: [
    {
      h2: 'Why a structured template matters',
      paragraphs: [
    ...
    {
      h2: 'Core elements of a pain diary entry',
      paragraphs: [
    ...
    {
      h2: 'Tracking medications and interventions',
      paragraphs: [
