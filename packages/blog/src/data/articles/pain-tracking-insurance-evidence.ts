...
const article: ArticleData = {
  ...
  description:
    'Structured pain tracking builds credible evidence for insurance and workers compensation claims. Here is what documentation reviewers actually look for and how to provide it.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Claims reviewers process hundreds of files with limited time per case. Clear, structured documentation that presents pain levels, functional impacts, medication use, and treatment compliance in an organised format is more persuasive than narrative descriptions or sporadic medical records. The quality of your documentation directly affects the speed and outcome of your claim. That is an uncomfortable truth, but it is the truth.',
      ],
    },
    {
