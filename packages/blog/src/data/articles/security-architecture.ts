...
const article: ArticleData = {
  ...
  h1: 'PainTracker Security Architecture: Defence in Depth for Health Data',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'PainTracker\'s security architecture is built on one principle: your health data should never exist anywhere you do not control. No server-side data storage. No remote databases. No cloud backups. No analytics pipelines that touch health information. Every security decision flows from this, and every feature is evaluated against it before implementation.',
    ...
    },
    {
      ...
      paragraphs: [
        'Zero-knowledge means the application operator has no ability to read your data, not in principle, not in practice. PainTracker\'s server serves static application files: HTML, CSS, JavaScript. It has no database, no API endpoints that accept health data, and no mechanism to receive information from your browser beyond standard requests for application code.',
    ...
    },
    {
      ...
      paragraphs: [
        'PainTracker implements a strict Content Security Policy that restricts which scripts can execute, which resources can be loaded, and which connections can be made. This mitigates cross-site scripting attacks, a common web vulnerability that could theoretically be used to extract data from the browser.',
    ...
    },
    {
      ...
      paragraphs: [
        'PainTracker defends against realistic threats: lost or stolen devices through at-rest encryption, XSS attacks through CSP and secure coding, malicious browser extensions through limited plaintext exposure, and shoulder-surfing through panic mode and minimal visible data.',
