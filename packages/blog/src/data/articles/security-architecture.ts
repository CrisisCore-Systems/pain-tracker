...
const article: ArticleData = {
  ...
  description:
    'Explore PainTracker\'s multi-layer security architecture including client-side encryption, zero-knowledge design, CSP, and defence-in-depth strategies for health data protection.',
