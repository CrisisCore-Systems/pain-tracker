...
const article: ArticleData = {
  ...
  description:
    'How PainTracker encrypts health data locally using Web Crypto APIs, passphrase-derived keys, and zero-knowledge design. Plain language, no cryptography background required.',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'The Web Crypto API provides the underlying cryptographic operations. This is a browser-native library maintained by browser vendors and reviewed by security researchers worldwide. PainTracker uses standard algorithms through this API rather than implementing custom cryptographic code. Custom crypto is how security fails. Standard reviewed libraries are how it holds.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'PainTracker cannot enforce passphrase strength without storing information about your passphrase, which would compromise the zero-knowledge guarantee. The responsibility rests with you. The reward is genuine cryptographic protection that no policy or promise can match.',
      ],
    },
    {
