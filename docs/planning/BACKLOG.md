...
3. Publish and maintain `docs/market/FEATURE_MATRIX.md`
   - Files: `docs/market/FEATURE_MATRIX.md` and components linking to it
...
6.   collector & guards for quantified empathy data flow
   - Files: referenced in `docs/product/QUANTIFIED_EMPATHY_DATA_FLOW.md`
