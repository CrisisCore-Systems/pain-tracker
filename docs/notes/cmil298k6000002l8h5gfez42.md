...
>
> **Role in the story:** This is the design-constraints post.
> If you want the personal motivation and trauma-informed framing first, read [Building Software That Actually Gives a Damn: My Journey with Trauma-Informed Design](https://blog.paintracker.ca/building-software-that-actually-gives-a-damn-my-journey-with-trauma-informed-design)
...
That line is the constraint that shaped the product.
...
If you want the technical answer for how that crisis-aware adaptation works without spying, read [Trauma-informed design left everyone asking: "How does it actually know I'm struggling without spying?"](https://dev.to/crisiscoresystems/trauma-informed-design-left-everyone-asking-how-does-it-actually-know-im-struggling-without-26a0).

If you want the component-layer hooks behind the large touch targets, auto-save, and emergency mode behaviors, read [Trauma-Informed React Hooks](https://dev.to/crisiscoresystems/trauma-informed-react-hooks-483n).
...
If you want the next step from design philosophy into implementation, read [Building Software That Actually Gives a Damn: My Journey with Trauma-Informed Design](https://blog.paintracker.ca/building-software-that-actually-gives-a-damn-my-journey-with-trauma-informed-design).
