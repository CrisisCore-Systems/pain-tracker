...
The insights are a work in progress and should be validated against your own data and context.  
The code is open-source and is designed to run locally by default (no central backend for entries in the default configuration).
