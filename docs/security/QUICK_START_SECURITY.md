...
- `docs/security/PRODUCTION_SECURITY_COMPLETE.md` - Full security docs
- `docs/engineering/FRONTEND_INTEGRATION_GUIDE.md` - Frontend migration
- `docs/security/SECURITY_IMPLEMENTATION_SUMMARY.md` - Implementation summary
